                ...
                <div className="flex h-full flex-col justify-center gap-10 p-4 md:h-[300px] md:flex-row">
                  ...
                  >
                    <div className="absolute left-1/2 top-1/2 h-6 w-6 -translate-x-1/2 -translate-y-1/2">
                      {/* Placeholder for DIcons.Designali - replace with your icon */}
                      <svg
                  ...
                  <div className="-mt-20 flex h-full flex-col justify-center p-2 md:-mt-4 md:ml-10 md:w-[400px]">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Link
                        href="mailto:aliman2952003@gmail.com"
                        target="_blank"
                        className={cn(
                          buttonVariants({
                            variant: "outline",
                      ...
                      >
                        <span className="flex items-center gap-1">
                          ...
                          <svg
                            ...
                            className="h-4 w-4"
                          >
                            <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004a9.87 9.87 0 00-5.031 1.378c-3.055 2.01-5.044 5.391-5.044 8.821 0 3.04.822 6.031 2.38 8.563L2.05 23.993l3.12-1.003A9.822 9.822 0 0012 24c5.39 0 9.797-4.407 9.797-9.797 0-2.611-.994-5.071-2.799-6.986-1.805-1.915-4.271-2.996-6.798-2.998z" />
                          </svg>
                        </span>
                      </Link>
                    </div>
